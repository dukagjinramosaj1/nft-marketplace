...
contract Marketplace {
  ...
  mapping(uint256 => bool) public activeItems; // tokenId => acitve?
  ...
  function burningToken(uint256 tokenId) public payable    OnlyItemOwner(tokenId)  {
    require(!activeItems[tokenId], "Item is already up for sale");
    token.burningToken(tokenId);
  }
}
